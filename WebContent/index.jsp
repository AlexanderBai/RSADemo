...
<body>
					...
					function() {
						...
						/*$.post("jiemi.do", jsonData, function(result) {
							alert("解密的用户名：" + result.uname + "\n"
									+ "解密的密码：" + result.password);
						}, 'json');*/

                        $.post("jiemi.do", jsonData,function (result) {
                            if ("AlexanderBai"==result.uname && "123456"==result.password){
                                alert("登录成功\n解密的用户名：" + result.uname + "\n"
                                    + "解密的密码：" + result.password);
	...
	<h2>公钥：</h2>
	<textarea id="publickey" rows="5" cols="45">MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCJ9s1qlOyv9qpuaTqauW6fUftzE50rVk3yVPZwv1aO1Ch/XSEz76xCwkyvqpaqceRXrPpdBmO5+ruJ+I8osOHo7L5GWEOcMOO+8izp9hXKBBrmRMD4Egpn00k9DhVIEKp/vyddZPS/doxB8onhN6poTJDLdFLFVEicMf52caN9GQIDAQAB</textarea>
	<h2>私钥</h2>
	...
	<form>
		...
		<hr />
		用户密文
		<textarea id="jmName"></textarea>
		密码密文
		<textarea id="jmPasswrod"></textarea>
